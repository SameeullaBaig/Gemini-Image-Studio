...
export const CropIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 7.5V18h10.5" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 16.5V6H5.25" />
    </svg>
);
...
export const ArrowPathIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0 3.181 3.183a8.25 8.25 0 0 0 11.667 0m0 0c1.863-1.863 1.863-4.887 0-6.75s-4.887-1.863-6.75 0-1.863 4.887 0 6.75ZM2.985 19.644l3.182-3.182m0 0-3.182 3.183m3.182-3.182L6.166 22.83m11.667-11.667-3.182 3.182m0 0 3.182-3.182m-3.182 3.182-3.181-3.183" />
    </svg>
);
